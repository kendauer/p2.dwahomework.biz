...
# What is the name of this app?
	define('APP_NAME', 'Squeak');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'kennethdauer@gmail.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'kennethdauer@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', "dwahomew_p2_dwahomework_biz"); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'E`lC]Z6Kox-h66546m$} 3jKH=TiI<}-ckjqtM|![5URR8:eZ|H/&i[SnBcKJ7aL|Kp');
	define('TOKEN_SALT', 'trewtretfhgbgfjh^%$^^&GDHer65');